package com.eastcom.csfb.data.mc.serializer;
...
public class McCallSerializer extends Serializer<McCallEvent> {
    ...
    public void write(Kryo kryo, Output output, McCallEvent mcCallEvent) {
        ...
        output.writeInt(mcCallEvent.getCmrspoffset(), true);
        ...
        output.writeInt(mcCallEvent.getPagingResptype(), true);
    ...
    public McCallEvent read(Kryo kryo, Input input, Class<McCallEvent> type) {
        ...
        mcCallEvent.setCmrspoffset(input.readInt(true));
        ...
        mcCallEvent.setPagingResptype(input.readInt(true));
