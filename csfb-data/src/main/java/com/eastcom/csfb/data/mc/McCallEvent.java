package com.eastcom.csfb.data.mc;
...
public class McCallEvent implements UserCommon {
    ...
    */
    ...
    public int getCmrspoffset() {
        return cmrspoffset;
    }

    public void setCmrspoffset(int cmrspoffset) {
        this.cmrspoffset = cmrspoffset;
    }
